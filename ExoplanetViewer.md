...
Three **guided tours** of ten systems each start from a picker at launch (or choose **Free flight**), and can be switched later: science-fiction landmarks, directly imaged worlds, and record holders (firsts, smallest, largest, farthest). **Next** walks the active tour; amber bookmarks mark only those stops. Search and free flight still reach the full catalog.
