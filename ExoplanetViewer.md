...
Four **guided tours** start from a picker at launch (or choose **Free flight**), and can be switched later: science-fiction landmarks, directly imaged worlds, record holders (firsts, smallest, largest, farthest), and **Goldilocks** worlds closest to Earth in size, mass, and sunlight. **Next** walks the active tour; amber bookmarks mark only those stops. Search and free flight still reach the full catalog.
