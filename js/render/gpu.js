...
/**
 * Same glow/spike star as STAR_WGSL, scaled for the focused AU frame
 * (clip.w ~ 1–3 pc). Galactic 195/dist would slam the pixel clamp.
 */
export const FOCUS_STAR_WGSL = /* wgsl */ `
${FRAME_WGSL}
...
fn vs_main(
  ...
  let px = clamp(sizeBright.x * 8.0 / dist * (0.9 + 0.12 * sparkle), 10.0, 92.0);
